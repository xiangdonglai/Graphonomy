...
def inferenceWrite(net, img_path='', output_path='./', output_name='f', use_gpu=True):
    '''
    ...
    parsing_im.save(output_path+'/{}.vis.png'.format(output_name))
...
def inference_batch(sourcemodel, imgPaths):
    ...
    for i, imgpath in enumerate(imgPaths):
        print('Running Segmentation on {}: No. {}/{}'.format(imgpath, i + 1, n))
